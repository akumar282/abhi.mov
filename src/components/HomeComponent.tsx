...
export function HomeComponent() {
  ...
  return (
    <>
      ...
      <div className='w-screen flex items-center flex-col text-center text-white font-primary justify-center bg-violet-500' id='about-section'>
        ...
        <div className='w-11/12 h-7/12 items-center flex-col  space-y-4 flex'>
          <h1 className='text-white font-primary text-2xl'>
            Experience
          </h1>
          <div className='h-full rounded-3xl w-11/12 bg-white/40 bg-clip-padding shadow-lg flex lg:flex-row flex-col items-start justify-center'>
            ...
            <div className='flex flex-col lg:mt-5 lg:w-8/12'>
              ...
              <h3 className='m-3'>
                ...
                I helped to design and develop tools to aid in the process of DO-178 and DO-330 software certification of the 777X and
                787 Dreamliner. I migrated the tech stack to use modern frameworks to ease the maintenance costs and speed up development.
                Additionally, I automated verification processes of aircraft system configuration files used by the Common Core System
                improving efficiency and lowering error rates.
              </h3>
            </div>
          </div>
          <div
            className='h-full rounded-3xl w-11/12 bg-white/40 bg-clip-padding shadow-lg flex lg:flex-row flex-col items-center justify-center'>
            <div className='lg:w-4/12 md:w-3/6  h-11/12 m-4 border-white bg-white border-10 rounded-3xl'>
